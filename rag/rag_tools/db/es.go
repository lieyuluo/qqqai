...
func NewES() (*elasticsearch.Client, error) {
	cfg := elasticsearch.Config{
		Addresses: config.GlobalConfig.ESConf.Addresses,
		Username:  config.GlobalConfig.ESConf.Username,
		Password:  config.GlobalConfig.ESConf.Password,
	}
	...
	indexName := config.GlobalConfig.ESConf.Index
